...
public class TopicUserSearch extends AppCompatActivity {
    ...
    private void firebaseUserSearch(Query SearchQuery) {
            ...
            protected void onBindViewHolder(Search.UserViewHolder userViewHolder, int position, Users model) {
                ...
                userViewHolder.mView.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view){
                        ...
                        Intent TopicProfileIntent = new Intent(TopicUserSearch.this, TopicProfile.class);
                        TopicProfileIntent.putExtra("user_id", user_id);
                        TopicProfileIntent.putExtra("topicID", topicID);
                        startActivity(TopicProfileIntent);
                    }
                });
            }
        ...
        hideKeyboard(TopicUserSearch.this);
